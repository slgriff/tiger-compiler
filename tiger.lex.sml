...
fun yyQ109 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction1(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\r"
              then yyQ109(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
            else if inp < #"\r"
              then if inp = #"\t"
                  then yyQ109(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
                else if inp < #"\t"
...
fun yyQ24 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction0(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\r"
              then yyQ109(strm', yyMATCH(strm, yyAction0, yyNO_MATCH))
            else if inp < #"\r"
              then if inp = #"\t"
                  then yyQ109(strm', yyMATCH(strm, yyAction0, yyNO_MATCH))
                else if inp < #"\t"
       ...
       of NONE => yyAction43(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction43(strm, yyNO_MATCH)
                  else yyQ97(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ59(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
              else yyAction43(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ38 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              then yyQ105(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp < #">"
              then if inp = #"="
...
fun yyQ34 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction28(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ108(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
...
fun yyQ20 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction59(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"/"
              then yyQ21(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
       ...
       of NONE => yyAction52(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp <= #"@"
                  then yyAction52(strm, yyNO_MATCH)
                  else yyQ15(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
            else if inp = #"a"
...
fun yyQ10 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction52(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ16(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
            else if inp < #"0"
              then yyAction52(strm, yyNO_MATCH)
            else if inp <= #"9"
              then yyQ16(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
            ...
            if inp = #"\\"
              ...
              then if inp = #"\""
                  ...
                  then if inp = #"\n"
                      ...
                      else yyQ8(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
                else if inp = #"0"
                  then yyQ10(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
                else if inp < #"0"
                  then yyQ8(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
                else if inp <= #"9"
                  then yyQ10(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
                  else yyQ8(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
            else if inp = #"n"
